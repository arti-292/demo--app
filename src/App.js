...
//                 onSubmit={() => {dispatch(addItem(arr))
                    
//                 }}
//             >{({ }) => {

//                 return (<Form onChange={(e) => setArr(e.target.value)}>

//                     <label htmlFor="inputField">input</label>
//                     <Field name="inputField" type="number" />
...
//           <li key={key}>
//             <td>{item}</td>
//             <td><button onClick={()=>dispatch(deleteItem(key))} >delete</button></td>
//           </li>
//         ))}
//       </ul>
